        ...
        <div className="container px-4 sm:px-6 lg:px-8">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-4">
              I'm an aspiring Software Engineer & Machine Learning Engineer with 3 years of hands-on experience developing systems and ML/AI models through academic projects and research. 
